#!/bin/bash
# AutoMem SessionStart reference script for Copilot.
# The actual session-start hook uses "type": "prompt" in JSON, so this script
# is provided for reference/debugging only. It outputs the same recall prompt
# that the hook JSON injects.
