...
class SessionMemoryProcessor:
    ...
    def load_filters(self) -> Dict[str, Any]:
        ...
        filters_path = script_filters if script_filters.exists() else Path.home() / ".copilot" / "scripts" / "memory-filters.json"
    ...
    def check_duplicate(self, content: str, timeframe_hours: int = 1) -> bool:
        ...
        queue_file = Path.home() / ".copilot" / "scripts" / "memory-queue.jsonl"
