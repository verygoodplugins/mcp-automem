...
printf '{"suppressOutput":true,"hookSpecificOutput":{"hookEventName":"%s","additionalContext":%s}}\n' "$EVENT_NAME" '"AutoMem status: no memory has been stored this session. Durable candidates: corrections, stabilized decisions, articulated patterns, and root-cause insights. Non-candidates: session summaries, progress notes, confirmations, and temporary output."'
