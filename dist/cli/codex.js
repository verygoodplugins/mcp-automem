...
const TEMPLATE_ROOT = path.resolve(fileURLToPath(new URL('../../templates/codex', import.meta.url)));
...
function upsertRulesWithMarkers(existing, block) {
...
export async function applyCodexSetup(cliOptions) {
...
export async function runCodexSetup(args = []) {
